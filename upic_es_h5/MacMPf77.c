...
void mp_init_(int *nproc) {
   MP_Init(nproc);
   return;
}

void mp_cr8task_(long (*entryPoint)(void *parameter), int *ttype,
...
void mp_taskstart_(int *taskid, void (*proc)(), int *nargs, int *arg1,
...
void mp_taskinit_(int *taskid, void (*proc)(), int *nargs, int *arg1,
                  int *arg2, int *arg3, int *arg4, int *arg5, int *arg6,
                  int *arg7, int *arg8, int *arg9, int *arg10, int *arg11,
                  int *arg12, int *arg13, int *arg14, int *arg15,
                  int *arg16, int *arg17, int *arg18, int *arg19,
...
void mp_taskbuild_(int *taskid, void (*proc)(), int *nargs, int *arg1,
                  int *arg2, int *arg3, int *arg4, int *arg5, int *arg6,
                  int *arg7, int *arg8, int *arg9, int *arg10, int *arg11,
                  int *arg12, int *arg13, int *arg14, int *arg15,
                  int *arg16, int *arg17, int *arg18, int *arg19,
