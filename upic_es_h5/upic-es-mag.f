...
! (none,2d periodic,2d reflecting,mixed reflecting/periodic)
      ...
      real, dimension(:,:,:,:), pointer :: fxye, bxye
...
! push electrons
     ...
     &norder,popt)
		...
		if (set_part_array_vdotE .eq. 0) then
        	call push_mag(part,fxye,b0,npp,noff,qbme,dt,wke,tpush,nx,ny,ipbc,inorder,popt)
		else
...
! push ions
     ...
     &ipbc,inorder,popt)
            ...
            call push_mag(parti,fxye,b0,nppi,noff,qbmi,dt,wki,tpushi,nx,ny,ipbc&
     &,inorder,popt)
         endif
         wki = wki*rmass
! move ions into appropriate spatial regions
