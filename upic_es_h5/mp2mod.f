...
!
      ...
      use p2d, only: dcomp, pcguard, pcguardp, paguard, paguardp,       &
     &pncguardp, pnaguardp, pfmove, repart, fnoff, dblsin, dblcos,      &
     &hafdbl, zdbl, plsum, plbcast, writebf, readbf, wrdata, rddata
      implicit none
      private
      ...
      public :: paguard, paguardp, pncguardp, pnaguardp
