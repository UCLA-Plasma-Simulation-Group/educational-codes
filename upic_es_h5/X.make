...
new_pbeps2.o : new_pbeps2.f pespush2mod.o pfield2mod.o pdiag2mod.o mp0mod.o
	$(FC90) $(OPTS90) $(MOPTS) -c new_pbeps2.f

new_mpbeps2.o : new_pbeps2.f mpespush2mod.o pfield2mod.o pdiag2mod.o mp0mod.o
	$(FC90) $(OPTS90) $(MOPTS) -o new_mpbeps2.o -c new_pbeps2.f

new_pbbeps2.o : new_pbbeps2.f pempush2mod.o pfield2mod.o pdiag2mod.o mp0mod.o
	$(FC90) $(OPTS90) $(MOPTS) -c new_pbbeps2.f

new_mpbbeps2.o : new_pbbeps2.f mpempush2mod.o pfield2mod.o pdiag2mod.o mp0mod.o
